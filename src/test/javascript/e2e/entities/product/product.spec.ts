...
describe('Product e2e test', () => {
  ...
  it('should create and save Products', async () => {
    ...
    await promise.all([
      productUpdatePage.setProductIDInput('64c99148-3908-465d-8c4a-e510e3ade974'),
      ...
      productUpdatePage.merchantSelectLastOption(),
    ]);

    expect(await productUpdatePage.getProductIDInput()).to.eq(
      '64c99148-3908-465d-8c4a-e510e3ade974',
      'Expected ProductID value to be equals to 64c99148-3908-465d-8c4a-e510e3ade974'
    );
