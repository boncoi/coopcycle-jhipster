...
describe('Basket e2e test', () => {
  ...
  it('should create and save Baskets', async () => {
    ...
    await promise.all([
      basketUpdatePage.setIdBasketInput('64c99148-3908-465d-8c4a-e510e3ade974'),
      basketUpdatePage.userSelectLastOption(),
      // basketUpdatePage.idProductSelectLastOption(),
    ]);

    expect(await basketUpdatePage.getIdBasketInput()).to.eq(
      '64c99148-3908-465d-8c4a-e510e3ade974',
      'Expected IdBasket value to be equals to 64c99148-3908-465d-8c4a-e510e3ade974'
    );
